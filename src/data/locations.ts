...
export const CITIES: CityLocation[] = [
  ...
  // Rajasthan (district-level)
  { slug: 'sri-ganganagar', name: 'Sri Ganganagar', state: 'Rajasthan', stateSlug: 'rajasthan', population: '250k', tier: 3 },
  { slug: 'chittorgarh', name: 'Chittorgarh', state: 'Rajasthan', stateSlug: 'rajasthan', population: '150k', tier: 3 },
  { slug: 'bundi', name: 'Bundi', state: 'Rajasthan', stateSlug: 'rajasthan', population: '120k', tier: 3 },
  { slug: 'dholpur', name: 'Dholpur', state: 'Rajasthan', stateSlug: 'rajasthan', population: '150k', tier: 3 },
  { slug: 'barmer', name: 'Barmer', state: 'Rajasthan', stateSlug: 'rajasthan', population: '120k', tier: 3 },
  { slug: 'jalore', name: 'Jalore', state: 'Rajasthan', stateSlug: 'rajasthan', population: '60k', tier: 3 },
  { slug: 'nagaur', name: 'Nagaur', state: 'Rajasthan', stateSlug: 'rajasthan', population: '120k', tier: 3 },
  { slug: 'sawai-madhopur', name: 'Sawai Madhopur', state: 'Rajasthan', stateSlug: 'rajasthan', population: '150k', tier: 3 },
  { slug: 'dausa', name: 'Dausa', state: 'Rajasthan', stateSlug: 'rajasthan', population: '100k', tier: 3 },
  { slug: 'karauli', name: 'Karauli', state: 'Rajasthan', stateSlug: 'rajasthan', population: '100k', tier: 3 },
  { slug: 'rajsamand', name: 'Rajsamand', state: 'Rajasthan', stateSlug: 'rajasthan', population: '80k', tier: 3 },
  { slug: 'pratapgarh', name: 'Pratapgarh', state: 'Rajasthan', stateSlug: 'rajasthan', population: '60k', tier: 3 },
  { slug: 'banswara', name: 'Banswara', state: 'Rajasthan', stateSlug: 'rajasthan', population: '120k', tier: 3 },
  { slug: 'sirohi', name: 'Sirohi', state: 'Rajasthan', stateSlug: 'rajasthan', population: '50k', tier: 3 },
  { slug: 'jhalawar', name: 'Jhalawar', state: 'Rajasthan', stateSlug: 'rajasthan', population: '70k', tier: 3 },
  // Uttar Pradesh (district-level)
  { slug: 'sultanpur', name: 'Sultanpur', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '150k', tier: 3 },
  { slug: 'bahraich', name: 'Bahraich', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '200k', tier: 3 },
  { slug: 'gonda', name: 'Gonda', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '150k', tier: 3 },
  { slug: 'basti', name: 'Basti', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '150k', tier: 3 },
  { slug: 'azamgarh', name: 'Azamgarh', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '150k', tier: 3 },
  { slug: 'ballia', name: 'Ballia', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '120k', tier: 3 },
  { slug: 'deoria', name: 'Deoria', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '150k', tier: 3 },
  { slug: 'etawah', name: 'Etawah', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '260k', tier: 3 },
  { slug: 'mainpuri', name: 'Mainpuri', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '120k', tier: 3 },
  { slug: 'fatehpur', name: 'Fatehpur', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '280k', tier: 3 },
  { slug: 'hardoi', name: 'Hardoi', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '200k', tier: 3 },
  { slug: 'lakhimpur-kheri', name: 'Lakhimpur Kheri', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '150k', tier: 3 },
  { slug: 'sitapur', name: 'Sitapur', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '200k', tier: 3 },
  { slug: 'unnao', name: 'Unnao', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '180k', tier: 3 },
  { slug: 'banda', name: 'Banda', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '170k', tier: 3 },
  { slug: 'hamirpur', name: 'Hamirpur', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '100k', tier: 3 },
  { slug: 'mahoba', name: 'Mahoba', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '100k', tier: 3 },
  { slug: 'chitrakoot', name: 'Chitrakoot', state: 'Uttar Pradesh', stateSlug: 'uttar-pradesh', population: '60k', tier: 3 },
  // Maharashtra (district-level)
  { slug: 'wardha', name: 'Wardha', state: 'Maharashtra', stateSlug: 'maharashtra', population: '150k', tier: 3 },
  { slug: 'chandrapur', name: 'Chandrapur', state: 'Maharashtra', stateSlug: 'maharashtra', population: '350k', tier: 3 },
  { slug: 'parbhani', name: 'Parbhani', state: 'Maharashtra', stateSlug: 'maharashtra', population: '350k', tier: 3 },
  { slug: 'nanded', name: 'Nanded', state: 'Maharashtra', stateSlug: 'maharashtra', population: '550k', tier: 3 },
  { slug: 'osmanabad', name: 'Osmanabad', state: 'Maharashtra', stateSlug: 'maharashtra', population: '120k', tier: 3 },
  { slug: 'beed', name: 'Beed', state: 'Maharashtra', stateSlug: 'maharashtra', population: '180k', tier: 3 },
  { slug: 'ahmednagar', name: 'Ahmednagar', state: 'Maharashtra', stateSlug: 'maharashtra', population: '400k', tier: 3 },
  { slug: 'dhule', name: 'Dhule', state: 'Maharashtra', stateSlug: 'maharashtra', population: '400k', tier: 3 },
  { slug: 'nandurbar', name: 'Nandurbar', state: 'Maharashtra', stateSlug: 'maharashtra', population: '120k', tier: 3 },
  { slug: 'ratnagiri', name: 'Ratnagiri', state: 'Maharashtra', stateSlug: 'maharashtra', population: '80k', tier: 3 },
  { slug: 'sindhudurg', name: 'Sindhudurg', state: 'Maharashtra', stateSlug: 'maharashtra', population: '50k', tier: 3 },
  { slug: 'satara', name: 'Satara', state: 'Maharashtra', stateSlug: 'maharashtra', population: '150k', tier: 3 },
  // Gujarat (district-level)
  { slug: 'patan', name: 'Patan', state: 'Gujarat', stateSlug: 'gujarat', population: '150k', tier: 3 },
  { slug: 'palanpur', name: 'Palanpur', state: 'Gujarat', stateSlug: 'gujarat', population: '150k', tier: 3 },
  { slug: 'godhra', name: 'Godhra', state: 'Gujarat', stateSlug: 'gujarat', population: '200k', tier: 3 },
  { slug: 'dahod', name: 'Dahod', state: 'Gujarat', stateSlug: 'gujarat', population: '150k', tier: 3 },
  { slug: 'surendranagar', name: 'Surendranagar', state: 'Gujarat', stateSlug: 'gujarat', population: '200k', tier: 3 },
  { slug: 'botad', name: 'Botad', state: 'Gujarat', stateSlug: 'gujarat', population: '130k', tier: 3 },
  { slug: 'amreli', name: 'Amreli', state: 'Gujarat', stateSlug: 'gujarat', population: '120k', tier: 3 },
  { slug: 'junagadh', name: 'Junagadh', state: 'Gujarat', stateSlug: 'gujarat', population: '320k', tier: 3 },
  // Madhya Pradesh (district-level)
  { slug: 'shivpuri', name: 'Shivpuri', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '200k', tier: 3 },
  { slug: 'datia', name: 'Datia', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '100k', tier: 3 },
  { slug: 'tikamgarh', name: 'Tikamgarh', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '80k', tier: 3 },
  { slug: 'chhatarpur', name: 'Chhatarpur', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '200k', tier: 3 },
  { slug: 'damoh', name: 'Damoh', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '150k', tier: 3 },
  { slug: 'mandsaur', name: 'Mandsaur', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '150k', tier: 3 },
  { slug: 'neemuch', name: 'Neemuch', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '130k', tier: 3 },
  { slug: 'khandwa', name: 'Khandwa', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '250k', tier: 3 },
  { slug: 'khargone', name: 'Khargone', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '150k', tier: 3 },
  { slug: 'seoni', name: 'Seoni', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '120k', tier: 3 },
  { slug: 'balaghat', name: 'Balaghat', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '100k', tier: 3 },
  { slug: 'mandla', name: 'Mandla', state: 'Madhya Pradesh', stateSlug: 'madhya-pradesh', population: '80k', tier: 3 },
  // Bihar (district-level)
  { slug: 'bettiah', name: 'Bettiah', state: 'Bihar', stateSlug: 'bihar', population: '170k', tier: 3 },
  { slug: 'motihari', name: 'Motihari', state: 'Bihar', stateSlug: 'bihar', population: '150k', tier: 3 },
  { slug: 'chapra', name: 'Chapra', state: 'Bihar', stateSlug: 'bihar', population: '250k', tier: 3 },
  { slug: 'siwan', name: 'Siwan', state: 'Bihar', stateSlug: 'bihar', population: '150k', tier: 3 },
  { slug: 'gopalganj', name: 'Gopalganj', state: 'Bihar', stateSlug: 'bihar', population: '80k', tier: 3 },
  { slug: 'arrah', name: 'Arrah', state: 'Bihar', stateSlug: 'bihar', population: '300k', tier: 3 },
  { slug: 'buxar', name: 'Buxar', state: 'Bihar', stateSlug: 'bihar', population: '120k', tier: 3 },
  { slug: 'aurangabad-bihar', name: 'Aurangabad', state: 'Bihar', stateSlug: 'bihar', population: '120k', tier: 3 },
  { slug: 'nawada', name: 'Nawada', state: 'Bihar', stateSlug: 'bihar', population: '100k', tier: 3 },
  { slug: 'jamui', name: 'Jamui', state: 'Bihar', stateSlug: 'bihar', population: '90k', tier: 3 },
  { slug: 'saharsa', name: 'Saharsa', state: 'Bihar', stateSlug: 'bihar', population: '170k', tier: 3 },
  { slug: 'supaul', name: 'Supaul', state: 'Bihar', stateSlug: 'bihar', population: '80k', tier: 3 },
  { slug: 'madhepura', name: 'Madhepura', state: 'Bihar', stateSlug: 'bihar', population: '70k', tier: 3 },
  { slug: 'khagaria', name: 'Khagaria', state: 'Bihar', stateSlug: 'bihar', population: '70k', tier: 3 },
  // West Bengal (district-level)
  { slug: 'jalpaiguri', name: 'Jalpaiguri', state: 'West Bengal', stateSlug: 'west-bengal', population: '150k', tier: 3 },
  { slug: 'cooch-behar', name: 'Cooch Behar', state: 'West Bengal', stateSlug: 'west-bengal', population: '120k', tier: 3 },
  { slug: 'malda', name: 'Malda', state: 'West Bengal', stateSlug: 'west-bengal', population: '300k', tier: 3 },
  { slug: 'murshidabad', name: 'Murshidabad', state: 'West Bengal', stateSlug: 'west-bengal', population: '50k', tier: 3 },
  { slug: 'birbhum', name: 'Birbhum', state: 'West Bengal', stateSlug: 'west-bengal', population: '60k', tier: 3 },
  { slug: 'purulia', name: 'Purulia', state: 'West Bengal', stateSlug: 'west-bengal', population: '150k', tier: 3 },
  { slug: 'bankura', name: 'Bankura', state: 'West Bengal', stateSlug: 'west-bengal', population: '150k', tier: 3 },
  { slug: 'midnapore', name: 'Midnapore', state: 'West Bengal', stateSlug: 'west-bengal', population: '180k', tier: 3 },
  { slug: 'haldia', name: 'Haldia', state: 'West Bengal', stateSlug: 'west-bengal', population: '200k', tier: 3 },
  // Punjab (district-level)
  { slug: 'ropar', name: 'Ropar', state: 'Punjab', stateSlug: 'punjab', population: '60k', tier: 3 },
  { slug: 'fatehgarh-sahib', name: 'Fatehgarh Sahib', state: 'Punjab', stateSlug: 'punjab', population: '60k', tier: 3 },
  { slug: 'sangrur', name: 'Sangrur', state: 'Punjab', stateSlug: 'punjab', population: '120k', tier: 3 },
  { slug: 'barnala', name: 'Barnala', state: 'Punjab', stateSlug: 'punjab', population: '120k', tier: 3 },
  { slug: 'moga', name: 'Moga', state: 'Punjab', stateSlug: 'punjab', population: '170k', tier: 3 },
  // Karnataka (district-level)
  { slug: 'hassan', name: 'Hassan', state: 'Karnataka', stateSlug: 'karnataka', population: '180k', tier: 3 },
  { slug: 'chikmagalur', name: 'Chikmagalur', state: 'Karnataka', stateSlug: 'karnataka', population: '140k', tier: 3 },
  { slug: 'bidar', name: 'Bidar', state: 'Karnataka', stateSlug: 'karnataka', population: '220k', tier: 3 },
  { slug: 'raichur', name: 'Raichur', state: 'Karnataka', stateSlug: 'karnataka', population: '250k', tier: 3 },
  { slug: 'kolar', name: 'Kolar', state: 'Karnataka', stateSlug: 'karnataka', population: '150k', tier: 3 },
  { slug: 'chitradurga', name: 'Chitradurga', state: 'Karnataka', stateSlug: 'karnataka', population: '140k', tier: 3 },
  // Tamil Nadu (district-level)
  { slug: 'ramanathapuram', name: 'Ramanathapuram', state: 'Tamil Nadu', stateSlug: 'tamil-nadu', population: '70k', tier: 3 },
  { slug: 'kumbakonam', name: 'Kumbakonam', state: 'Tamil Nadu', stateSlug: 'tamil-nadu', population: '200k', tier: 3 },
  { slug: 'pollachi', name: 'Pollachi', state: 'Tamil Nadu', stateSlug: 'tamil-nadu', population: '100k', tier: 3 },
  { slug: 'rajapalayam', name: 'Rajapalayam', state: 'Tamil Nadu', stateSlug: 'tamil-nadu', population: '150k', tier: 3 },
  { slug: 'sivakasi', name: 'Sivakasi', state: 'Tamil Nadu', stateSlug: 'tamil-nadu', population: '120k', tier: 3 },
  { slug: 'neyveli', name: 'Neyveli', state: 'Tamil Nadu', stateSlug: 'tamil-nadu', population: '150k', tier: 3 },
  // Telangana (district-level)
  { slug: 'khammam', name: 'Khammam', state: 'Telangana', stateSlug: 'telangana', population: '300k', tier: 3 },
  { slug: 'mahabubnagar', name: 'Mahabubnagar', state: 'Telangana', stateSlug: 'telangana', population: '200k', tier: 3 },
  { slug: 'adilabad', name: 'Adilabad', state: 'Telangana', stateSlug: 'telangana', population: '140k', tier: 3 },
  { slug: 'nalgonda', name: 'Nalgonda', state: 'Telangana', stateSlug: 'telangana', population: '160k', tier: 3 },
  { slug: 'suryapet', name: 'Suryapet', state: 'Telangana', stateSlug: 'telangana', population: '120k', tier: 3 },
  { slug: 'siddipet', name: 'Siddipet', state: 'Telangana', stateSlug: 'telangana', population: '100k', tier: 3 },
  // Haryana (district-level)
  { slug: 'kaithal', name: 'Kaithal', state: 'Haryana', stateSlug: 'haryana', population: '150k', tier: 3 },
  { slug: 'kurukshetra', name: 'Kurukshetra', state: 'Haryana', stateSlug: 'haryana', population: '120k', tier: 3 },
  { slug: 'sirsa', name: 'Sirsa', state: 'Haryana', stateSlug: 'haryana', population: '200k', tier: 3 },
  { slug: 'fatehabad', name: 'Fatehabad', state: 'Haryana', stateSlug: 'haryana', population: '100k', tier: 3 },
  { slug: 'jind', name: 'Jind', state: 'Haryana', stateSlug: 'haryana', population: '180k', tier: 3 },
  // Jammu & Kashmir
  { slug: 'jammu', name: 'Jammu', state: 'Jammu & Kashmir', stateSlug: 'jammu-and-kashmir', population: '700k', tier: 3 },
  { slug: 'anantnag', name: 'Anantnag', state: 'Jammu & Kashmir', stateSlug: 'jammu-and-kashmir', population: '150k', tier: 3 },
  // Northeast & UTs
  { slug: 'itanagar', name: 'Itanagar', state: 'Arunachal Pradesh', stateSlug: 'arunachal-pradesh', population: '60k', tier: 3 },
  { slug: 'gangtok', name: 'Gangtok', state: 'Sikkim', stateSlug: 'sikkim', population: '100k', tier: 3 },
  { slug: 'dimapur', name: 'Dimapur', state: 'Nagaland', stateSlug: 'nagaland', population: '200k', tier: 3 },
  { slug: 'imphal', name: 'Imphal', state: 'Manipur', stateSlug: 'manipur', population: '300k', tier: 3 },
  { slug: 'lunglei', name: 'Lunglei', state: 'Mizoram', stateSlug: 'mizoram', population: '60k', tier: 3 },
  { slug: 'shillong', name: 'Shillong', state: 'Meghalaya', stateSlug: 'meghalaya', population: '150k', tier: 3 },
  { slug: 'agartala', name: 'Agartala', state: 'Tripura', stateSlug: 'tripura', population: '400k', tier: 3 },
  { slug: 'leh', name: 'Leh', state: 'Ladakh', stateSlug: 'ladakh', population: '40k', tier: 3 },
  { slug: 'port-blair', name: 'Port Blair', state: 'Andaman & Nicobar Islands', stateSlug: 'andaman-and-nicobar', population: '100k', tier: 3 },
  { slug: 'silvassa', name: 'Silvassa', state: 'Dadra & Nagar Haveli', stateSlug: 'dadra-and-nagar-haveli', population: '25k', tier: 3 },
  { slug: 'puducherry', name: 'Puducherry', state: 'Puducherry', stateSlug: 'puducherry', population: '250k', tier: 3 },
  { slug: 'kavaratti', name: 'Kavaratti', state: 'Lakshadweep', stateSlug: 'lakshadweep', population: '10k', tier: 3 },
]
