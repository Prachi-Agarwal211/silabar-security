...
export const INDUSTRIES: Industry[] = [
  ...
  },
  {
    ...
    description: 'Armed security for banks, NBFCs, insurance offices, and financial institutions.',
  ...
  },
  {
    ...
    description: 'Security for government offices, PSUs, defence facilities, and public sector organizations.',
    ...
    solutions: ['Police-verified guards with security clearance', 'Documentation compliance', 'VIP escort and protocol management', 'Coordination with SPG/CRPF/local police', 'Detailed daily security reports'],
