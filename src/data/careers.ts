...
<h3>What You'll Do</h3>
<p>Security Supervisors at Silbar are responsible for managing daily guard deployment and attendance, conducting field patrol rounds to inspect guard posts, briefing guards at shift change about site-specific instructions, handling client escalations and on-ground issues immediately, conducting surprise checks and random patrol verification, ensuring all guards are in proper uniform and equipped with necessary gear, maintaining site-level documentation including incident reports and daily logs, and reporting to the Account Manager with daily performance updates. You are the face of Silbar Security on the ground.</p>
<h3>Why Join Silbar Security</h3>
<p>Silbar Security is one of India's fastest-growing security companies with a PAN India presence across 200+ cities. We invest heavily in our supervisory staff because they are the backbone of our operations. As a Security Supervisor at Silbar, you will receive advanced training in leadership, conflict resolution, and client management. We offer competitive salaries, full statutory benefits, performance bonuses, and clear career growth to Account Manager and Regional Manager roles.</p>`,
    responsibilities: [
...
<h3>Why Join Silbar Security</h3>
<p>The Indian private security industry is growing at 15–20% annually, and Silbar Security is positioned as one of the fastest-growing players in this space. As a BDE, you will have the opportunity to sell a comprehensive portfolio of services backed by ISO certifications, a 3-acre training center, and a 7,000+ workforce across 200+ cities. We offer an attractive compensation structure with a competitive base salary, uncapped incentives, travel allowance, and fast-track promotion based on performance.</p>`,
    responsibilities: [
...
<h3>Why Join Silbar Security</h3>
<p>Silbar Security is expanding its electronic surveillance division rapidly, installing and maintaining security systems for corporate clients, factories, hospitals, and government facilities. As a CCTV Technician at Silbar, you will work with leading brands — CP Plus, Hikvision, Dahua, Honeywell, Bosch, and ZKTeco — gaining valuable hands-on experience. We offer a competitive salary, travel allowances, tool kit provision, and opportunities for advanced technical training and certification sponsored by the company.</p>`,
    responsibilities: [
...
<h3>Why Join Silbar Security</h3>
<p>Silbar Security is a PSARA-licensed organization operating across 19+ states, making this role a rich learning opportunity for HR professionals interested in multi-state labour law compliance. You will gain hands-on experience managing a large, distributed workforce in one of India's most regulated industries. We offer a professional work environment, competitive salary, and opportunities for growth to Senior HR and HR Manager roles.</p>`,
    responsibilities: [
