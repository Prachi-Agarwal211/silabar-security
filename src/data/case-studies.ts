...
<p>Silbar Security developed a comprehensive Hospital Security Manual covering access control, visitor management, pharmacy security, emergency response, and incident reporting — standardised across all four locations. A central security manager was appointed to oversee all sites, with location-specific security supervisors reporting into the central command. Monthly cross-location audits were instituted, with scores published on a dashboard visible to the hospital COO.</p>
...
<p>Silbar Security designed a three-tier loss prevention framework: uniformed visible deterrence at store entry and exit points, plain-clothes loss prevention officers on the sales floor, and behind-the-scenes audit controls focused on cash management and vendor receipts. A National Loss Prevention Manager was appointed to oversee the program, with regional supervisors conducting unannounced store audits on a rotating schedule. Each store received a customised security manual tailored to its layout, product mix, and footfall patterns.</p>
...
<p>Silbar Security established a Security Command Centre at the park entrance, equipped with CCTV monitoring for 64 cameras covering the main gate, internal roads, parking yards, and warehouse perimeters. The centre operates 24/7 with two dedicated monitoring staff per shift, radio communication with all field personnel, and a direct hotline to the nearest police station and fire station. A park-wide incident response protocol ensures that any security or safety event is communicated to all tenants within minutes.</p>
