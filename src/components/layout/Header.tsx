        ...
        <div className="mx-auto max-w-[1440px] px-[clamp(1.5rem,5vw,6rem)]">
          <div className="flex h-20 items-center justify-between">
            ...
            <nav className="hidden items-center gap-10 md:flex" aria-label="Main navigation">
              ...
              <Link
                href="/contact"
                className="btn-gold-glow inline-flex h-10 items-center px-6 text-sm font-bold focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-400"
              >
                Get Quote
              </Link>
            </nav>
          ...
          {mobileOpen && (
            <nav className="glass border-t border-gold-400/10 pb-6 pt-4 md:hidden" aria-label="Mobile navigation">
              ...
              <Link
                href="/contact"
                className="btn-gold-glow mt-4 inline-flex h-10 w-full items-center justify-center text-sm font-bold focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-400"
                onClick={() => setMobileOpen(false)}
              >
                Get Quote
              </Link>
