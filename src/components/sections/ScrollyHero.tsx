...
const services = [
  { name: 'Guard Services', icon: '🛡️', color: '#D4AF37' },
  { name: 'CCTV Surveillance', icon: '📹', color: '#42638C' },
  { name: 'Vehicle Patrol', icon: '🚔', color: '#B8941E' },
  { name: 'Access Control', icon: '🔐', color: '#2E4A6B' },
  { name: 'Fire Safety', icon: '🔥', color: '#CC2222' },
]
...
function FloatingParticles() {
  const particles = useMemo(() => {
    return Array.from({ length: 20 }, (_, i) => ({
      ...
      color: i % 3 === 0 ? 'particle-red' : 'particle-gold',
...
export default function ScrollyHero() {
  ...
  useGSAP(() => {
    ...
    // ========== PHASE 2: "THE BREACH" — stronger red ==========
    tl.addLabel('phase2')
      .to('.red-overlay', {
        opacity: 0.85,
        duration: 0.3,
    ...
    tl.addLabel('phase3')
      ...
      .from('.phase-3-subtitle', {
        yPercent: 20,
        opacity: 0,
        duration: 1.5,
      }, 'phase3+=3.5')
      .to('.phase-3-text, .phase-3-subtitle, .shield-logo', {
        opacity: 0,
        duration: 1,
      }, 'phase3+=5.5')
    ...
    services.forEach((_, i) => {
      ...
      tl.from(`.service-layer-${i}`, {
        clipPath: directions[i],
        duration: 2,
        ease: 'power2.inOut',
      }, `phase4+=${i * 2}`)
    })
    tl.from('.phase-4-label', {
      opacity: 0,
      y: 20,
      duration: 1.5,
    }, 'phase4+=4')
    tl.to('.services-stack', {
      opacity: 0,
      duration: 1,
    }, 'phase4+=11')
  ...
  if (typeof window !== 'undefined' && window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    return (
      <section className="gradient-mesh relative flex min-h-screen items-center justify-center">
        <div className="px-8 text-center">
          <div className="relative mx-auto mb-8 h-24 w-24 overflow-hidden">
            <Image src="/logo.png" alt="Silbar Security" fill className="object-contain" sizes="96px" />
          </div>
          <h1 className="mb-4 font-display text-[clamp(3rem,8vw,8rem)] text-horizon-50">SILBAR SECURITY</h1>
          <p className="mb-8 text-xl text-horizon-300">India&apos;s Premier Physical Security & Facility Management</p>
          <a href="/contact" className="btn-gold-glow inline-flex h-12 items-center px-8 text-sm font-bold">
  ...
  return (
    <section ref={sectionRef} className="scrolly-hero">
      ...
      <div className="layer layer-bg">
        ...
        <div aria-hidden="true"><FloatingParticles /></div>

        {/* Chaos scene */}
        <div className="chaos-scene">
          <div className="chaos-circle" />
          <div className="chaos-overlay" />
          {/* Abstract chaos using gradients — decorative */}
      ...
      <div className="layer layer-mid">
        ...
        <div className="services-stack absolute inset-0 flex items-center justify-center">
          ...
          <div className="phase-4-label absolute bottom-[10%] left-1/2 -translate-x-1/2 text-center">
            <p className="text-sm tracking-[0.3em] text-gold-400">LAYERED PROTECTION</p>
            <div className="mx-auto mt-2 h-px w-12 bg-gradient-to-r from-transparent via-gold-400/40 to-transparent" />
        ...
        <div className="phase-5-group absolute inset-0 flex items-center justify-center">
          ...
          <div className="phase-5-text absolute bottom-[12%] left-1/2 -translate-x-1/2 text-center">
            ...
            <div className="mx-auto mt-3 h-px w-16 bg-gradient-to-r from-transparent via-gold-400/40 to-transparent" />
            <p className="phase-5-subtitle mt-3 text-sm tracking-[0.2em] text-gold-400">ACROSS INDIA</p>
          </div>
        </div>
      ...
      <div className="layer layer-fg pointer-events-none">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h2 className="phase-2-text font-display text-[clamp(2rem,6vw,5rem)] text-red-500 text-glow">
            THE THREAT IS REAL
          </h2>
          <div className="phase-2-stat mt-8 text-center">
            <p className="text-sm tracking-[0.2em] text-horizon-400">ANNUAL LOSSES IN INDIA</p>
          ...
          <div className="phase-2-stat mt-6 text-center">
            <p className="text-sm tracking-[0.2em] text-horizon-400">UNSECURED PREMISES</p>
            <p className="mt-2 font-display text-[clamp(2rem,5vw,4rem)] text-red-400">73%</p>
          </div>
        </div>

        {/* Phase 3: "SILBAR SECURITY" — with actual logo */}
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="shield-logo relative mb-8 flex h-28 w-28 items-center justify-center border-2 border-red-500/50 bg-midnight-800/90 backdrop-blur-sm shield-glow">
            <div className="absolute inset-0 border border-gold-400/20" style={{ transform: 'scale(1.12)' }} />
            <Image
              src="/logo.png"
              alt="Silbar Security Shield"
              fill
              className="object-contain p-2"
              sizes="112px"
            />
          </div>
          <h1 className="phase-3-text font-display text-[clamp(3rem,10vw,8rem)] text-horizon-50">
            SILBAR
          </h1>
          <h1 className="phase-3-text font-display text-[clamp(3rem,10vw,8rem)] text-horizon-50">
            SECURITY
          ...
          <p className="phase-3-subtitle mt-6 text-sm tracking-[0.4em] text-gold-400">
            INDIA&apos;S PREMIER SECURITY PARTNER
          </p>
        </div>
        ...
        <div className="final-bg absolute inset-0 flex flex-col items-center justify-center bg-midnight-950/0">
          ...
          <div className="mt-6 h-px w-32 bg-gradient-to-r from-transparent via-gold-400/40 to-transparent" />
          ...
          <div className="cta-block mt-10 flex flex-col items-center gap-4 sm:flex-row">
            <a
              href="/contact"
              className="pointer-events-auto btn-gold-glow magnetic-btn inline-flex h-14 items-center px-10 text-sm font-bold"
            >
              Get Security Assessment
            </a>
            <a
              href={SITE.phoneTel}
              className="pointer-events-auto btn-red-glow magnetic-btn inline-flex h-14 items-center px-10 text-sm font-bold"
            >
              Call: {SITE.phone}
            </a>
          </div>
          {/* Scroll indicator — decorative */}
          <div aria-hidden="true" className="floating-cta absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
            <span className="text-[10px] tracking-[0.3em] text-horizon-400">SCROLL</span>
      ...
      <div className="layer layer-overlay">
        ...
        {/* Breach flash — instant red burst */}
